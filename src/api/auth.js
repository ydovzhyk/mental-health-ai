...
export const axiosCheckAccessCode = async userData => {
  const { data } = await instance.post('/auth/check-access-code', userData);
  return data;
};

export const axiosRegisterIncognito = async userData => {
  const { data } = await instance.post('/auth/register-incognito', userData);
  return data;
};
...
export const axiosLoginIncognito = async userData => {
  const { data } = await instance.post('/auth/login-incognito', userData);
  return data;
};
