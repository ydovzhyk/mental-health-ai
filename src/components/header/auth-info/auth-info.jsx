          ...
          <div className="flex justify-between items-center gap-[5px]">
            <Link href="/login" className="w-full group cursor-pointer">
              <Text
                ...
                as="p"
                fontWeight="normal"
                className="text-black group-hover:text-[var(--accent)] hover-transition"
              >
                Login
              </Text>
            </Link>
            <div>
              <PiLineVertical size={24} color="gray" />
            </div>
      ...
      {isUserLogin && screenType !== 'isMobile' && (
        <div className="flex flex-row items-center justify-between gap-[15px]">
          <div className="mr-[20px]">
            <Button
              text={`${user.role === 'doctor' ? 'Doctor Dashboard' : 'Your Cabinet'}`}
              btnClass="btnHeader"
          ...
          {/* <AddUserPanel /> */}
          <div className="flex flex-row items-center justify-between gap-[10px] w-[45px] h-[45px] bg-transparent rounded-full">
          ...
          >
            <Text
              ...
              as="span"
              fontWeight="normal"
              className="text-black group-hover:text-[var(--accent)]"
            >
              Exit
            </Text>
          </button>
